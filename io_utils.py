...
def parse_args(script):
    ...
    if script == 'train':
        parser.add_argument('--num_classes' , default=50030, type=int, help='total number of classes in softmax, only used in baseline') #make it larger than the maximum label value in base class
